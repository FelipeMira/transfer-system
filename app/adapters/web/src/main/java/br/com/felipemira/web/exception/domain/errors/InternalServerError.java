...
@Getter
public class InternalServerError extends CustomException implements ErrorStrategy {

    public InternalServerError(String message, int statusCode, String statusDescription) {
    ...
    @Schema(description = "Status Description", example = "Internal server error")
    private String statusDescription;

    @Schema(description = "Thrown exception", example = "internalServerErrorException")
