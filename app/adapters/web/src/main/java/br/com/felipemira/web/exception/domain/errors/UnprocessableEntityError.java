...
@Schema(description = "UI Unprocessable entity error response")
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
@Getter
public class UnprocessableEntityError extends CustomException implements ErrorStrategy {

    public UnprocessableEntityError(String message, int statusCode, String statusDescription) {
    ...
    @Schema(description = "Status Description", example = "Unprocessable entity")
    private String statusDescription;

    @Schema(description = "Thrown exception", example = "UnprocessableEntityException")
