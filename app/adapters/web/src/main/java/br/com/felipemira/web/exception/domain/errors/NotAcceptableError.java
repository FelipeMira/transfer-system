...
@Schema(description = "Not Acceptable error response")
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
@Getter
public class NotAcceptableError extends CustomException implements ErrorStrategy {

    public NotAcceptableError(String message, int statusCode, String statusDescription) {
    ...
    @Schema(description = "Status code", example = "406")
    private int statusCode;

    @Schema(description = "Status Description", example = "Not Acceptable")
    private String statusDescription;

    @Schema(description = "Thrown exception", example = "NotAcceptableException")
