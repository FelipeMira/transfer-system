...
@Schema(description = "Business error response")
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
@Getter
public class BusinessError extends CustomException implements ErrorStrategy {

    public BusinessError(String message, int statusCode, String statusDescription) {
    ...
    @Schema(description = "Thrown exception", example = "BusinessException")
